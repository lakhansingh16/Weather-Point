...
const API_KEY = 'a9f72ac1b74dafea9057ad02f9d7c6ae';
setInterval(()=>{
    const time = new Date();
...
function getWeatherData(){
    navigator.geolocation.getCurrentPosition((success)=>{
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&exclude=hourly,minutely,alerts&units=metric&appid=${API_KEY}`).then(
...
function showWeatherData(data){
    ...
    <div class="weather-item">
    <div style="padding-right:10px;">Sunrise</div>
